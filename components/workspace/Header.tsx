...
function LogoMark() {
  return (
    <svg width="22" height="22" viewBox="0 0 64 64" fill="none" aria-hidden="true">
      <path d="M8 22 L8 52 Q8 56 12 56 L52 56 Q56 56 56 52 L56 22 L40 22 L36 16 L8 16 Q8 16 8 22 Z" stroke="currentColor" strokeWidth="3" strokeLinejoin="round" fill="none" opacity="0.5"/>
      <path d="M14 28 L14 48 Q14 50 16 50 L48 50 Q50 50 50 48 L50 28 L38 28 L35 24 L14 24 Q14 24 14 28 Z" stroke="currentColor" strokeWidth="3" strokeLinejoin="round" fill="none" opacity="0.8"/>
  ...
  return (
    <header className="tl-header">
      ...
      <div className="tl-header-right">
        ...
        <span className="tl-stat-sep" aria-hidden="true">·</span>
        <span className="tl-stat">
        ...
        <span className="tl-stat-sep" aria-hidden="true">·</span>
        <span className="tl-stat">
          <span className="tl-stat-num">{totalTabs.toLocaleString()}</span>
