...
const sampleTabs: TabInfo[] = [
  { id: 1, url: 'https://example.com', title: 'Example', faviconUrl: '', windowId: 1, active: true },
  { id: 2, url: 'https://github.com', title: 'GitHub', faviconUrl: '', windowId: 1, active: false },
];
...
describe('useLiveTabs', () => {
  ...
  it('re-queries when onCreated fires', async () => {
    const extra: TabInfo = { id: 3, url: 'https://new.io', title: 'New', faviconUrl: '', windowId: 1, active: false };
    ...
    await act(async () => {});
    expect(result.current).toHaveLength(2);
    await act(async () => { onCreated.fire({}); });
  ...
  it('re-queries when onRemoved fires', async () => {
    ...
    await act(async () => {});
    expect(result.current).toHaveLength(2);
    await act(async () => { onRemoved.fire(2); });
