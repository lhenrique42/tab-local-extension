...
describe("Workspace", () => {
    ...
    it("renders a GroupSection for each group in the root", () => {
        ...
        expect(
            screen.getByRole("heading", { level: 2, name: "Group One" }),
        ).toBeInTheDocument();
        expect(
            screen.getByRole("heading", { level: 2, name: "Group Two" }),
        ).toBeInTheDocument();
    });
    ...
    it("renders stats in the header", () => {
        ...
        render(<Workspace root={root} loading={false} />);
        expect(
            screen.getByLabelText("Search tabs and collections"),
        ).toBeInTheDocument();
    });
    ...
    it("filters groups by search query", async () => {
        ...
        expect(
            screen.queryByRole("heading", { level: 2, name: "Personal" }),
...
describe("GroupSection", () => {
    ...
    it("renders the group name", () => {
        ...
        render(
            <GroupSection group={group} collections={[]} {...noopHandlers} />,
        );
...
describe("CollectionCard", () => {
    ...
    it("expands TabList when card is clicked", async () => {
        const collection = makeCollection({
            ...
            tabs: [
                makeTab({
                    title: "My Expanded Tab",
                    url: "https://expand.com",
                }),
            ],
        });
        render(
