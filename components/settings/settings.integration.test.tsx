...
vi.mock('../../lib/hooks/useStorage', () => ({
  useStorage: () => {
    ...
    root.groups = {
      'group-1': { id: 'group-1', name: 'My Group', color: 'blue', collectionIds: ['col-1'] }
    };
    root.collections = {
...
describe('Settings E2E Integration - Data Portability', () => {
  ...
  it('runs E2E flow: export data -> clear storage -> import exported file -> data restored', async () => {
    ...
    seedRoot.groups = {
      'group-1': { id: 'group-1', name: 'E2E Group', color: 'tg-blue', collectionIds: ['col-1'] }
    };
    ...
    const file = new File([exportedBlobContent], 'tablocal-export.json', { type: 'application/json' });
